#
#  Be sure to run `pod spec lint GDAO.podspec' to ensure this is a
...
As a bonus it contains JSON to CoreData parser, this parser cand be extend to suport any persistence mechanism.
  ...
  s.homepage     = "https://github.com/vadeara/GDAO"
  ...
  s.source       = { :git => "https://github.com/vadeara/GDAO.git", :tag => "#{s.version}" }
